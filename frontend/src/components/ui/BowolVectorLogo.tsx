...
interface BowolVectorLogoProps {
  className?: string;
  size?: 'sm' | 'md' | 'lg' | 'xl';
  variant?: 'full' | 'emblem' | 'wordmark';
}

export const BowolVectorLogo: React.FC<BowolVectorLogoProps> = ({
  className = '',
  size = 'md',
  variant = 'full',
}) => {
  // Sizing maps
  const sizeClasses = {
    sm: variant === 'emblem' ? 'w-7 h-7' : 'h-8 w-auto',
    md: variant === 'emblem' ? 'w-9 h-9' : 'h-10 w-auto',
    lg: variant === 'emblem' ? 'w-12 h-12' : 'h-14 w-auto',
    xl: variant === 'emblem' ? 'w-16 h-16' : 'h-20 w-auto',
  };

  if (variant === 'emblem') {
    return (
      <svg
        viewBox="400 120 500 380"
        xmlns="http://www.w3.org/2000/svg"
        className={`${sizeClasses[size]} ${className} text-zinc-900 dark:text-zinc-100 transition-colors duration-200 select-none`}
        aria-label="BOWOL Emblem"
      >
        <defs>
          <linearGradient id="vector-flame-grad" x1="0" y1="0" x2="0" y2="1">
  ...
  if (variant === 'wordmark') {
    return (
      <svg
        viewBox="240 560 760 140"
        xmlns="http://www.w3.org/2000/svg"
        className={`${sizeClasses[size]} ${className} text-zinc-900 dark:text-zinc-100 select-none`}
        aria-label="BOWOL Wordmark"
      >
        <g transform="translate(0, 862) scale(0.1, -0.1)">
          {/* Letter B */}
          <path
          ...
          />
          {/* Exact Geometric Amber/Orange Letter W */}
          <path
            fill="#F5A623"
            className="text-orange-500 dark:text-[#F5A623]"
  ...
  return (
    <svg
      ...
      xmlns="http://www.w3.org/2000/svg"
      className={`${sizeClasses[size]} ${className} text-zinc-900 dark:text-zinc-100 select-none`}
      aria-label="BOWOL Official Logo"
    >
      <defs>
        <linearGradient id="vector-flame-grad-full" x1="0" y1="0" x2="0" y2="1">
          <stop offset="0%" stopColor="#FDBA74" />
          <stop offset="60%" stopColor="#F97316" />
          <stop offset="100%" stopColor="#EA580C" />
        </linearGradient>
      ...
      <g transform="translate(0, 862) scale(0.1, -0.1)">
        ...
        {/* Thrusters and Flame */}
        <g>
          <path fill="url(#vector-flame-grad-full)" d="M6004 5787 c-34 -45 -84 -116 -112 -157 l-52 -75 19 -85 c55 -248 104 -425 117 -425 9 0 84 110 156 229 l42 69 -32 161 c-17 88 -39 204 -48 256 -8 52 -19 98 -23 102 -3 4 -34 -29 -67 -75z" />
          <path fill="url(#vector-flame-grad-full)" d="M6970 5861 c0 -13 -67 -367 -85 -451 -16 -74 -17 -72 94 -239 31 -45 63 -94 71 -107 20 -32 26 -30 39 9 28 86 111 435 111 467 0 31 -17 60 -104 177 -100 136 -126 165 -126 144z" />
          <path fill="url(#vector-flame-grad-full)" d="M 6450 5800 C 6620 5400 6640 4800 6450 4200 C 6260 4800 6280 5400 6450 5800 Z" />
        </g>
        {/* Wordmark */}
        <g fill="currentColor">
          <path d="M2632 2818 c-9 -9 -12 -128 -12 -474 0 -254 3 -469 6 -478 5 -14 49 -16 393 -16 423 0 457 4 556 59 29 17 64 48 85 76 30 42 35 58 38 117 7 116 -38 192 -142 242 l-47 23 39 26 c75 53 104 140 78 232 -32 107 -129 176 -278 195 -112 14 -701 13 -716 -2z m684 -230 c57 -56 21 -130 -68 -143 -24 -3 -104 -5 -178 -3 l-135 3 -3 74 c-2 41 -1 80 2 88 5 12 37 14 181 11 174 -3 175 -3 201 -30z m48 -367 c34 -32 40 -56 26 -91 -25 -59 -45 -65 -262 -68 l-198 -4 0 97 0 96 204 -3 c200 -3 205 -3 230 -27z" />
          <path d="M4625 2836 c-149 -29 -261 -84 -351 -173 -157 -155 -189 -359 -89 -554 25 -46 118 -142 175 -179 73 -47 199 -89 303 -100 310 -36 583 88 693 315 38 78 39 82 39 190 0 105 -2 113 -34 180 -46 93 -150 197 -248 248 -137 71 -340 102 -488 73z m207 -227 c164 -34 269 -156 255 -294 -10 -100 -68 -173 -177 -224 -47 -22 -68 -26 -150 -26 -82 1 -102 4 -151 28 -62 30 -121 82 -145 129 -22 42 -29 133 -15 185 25 90 112 168 221 197 68 18 95 19 162 5z" />
          {/* Amber W */}
          <path
            fill="#F5A623"
            d="M 5670 2820 L 5970 2820 L 6230 2300 L 6480 2820 L 6650 2820 L 6920 2300 L 7160 2820 L 7450 2820 L 7020 1860 L 6810 1860 L 6560 2370 L 6300 1860 L 6090 1860 Z"
          />
          <path d="M8285 2839 c-287 -42 -502 -235 -521 -469 -12 -140 36 -261 146 -368 73 -72 182 -131 295 -158 95 -24 305 -23 394 0 302 81 481 321 427 575 -47 221 -246 383 -519 420 -89 12 -136 12 -222 0z m251 -250 c73 -27 157 -107 173 -166 40 -144 -22 -270 -167 -336 -37 -17 -66 -22 -142 -22 -82 0 -103 4 -151 26 -176 82 -226 279 -107 414 94 107 245 139 394 84z" />
          <path d="M9533 2824 c-10 -5 -13 -112 -13 -490 l0 -484 470 0 471 0 -3 123 -3 122 -312 3 -313 2 -2 363 -3 362 -140 2 c-77 1 -146 -1 -152 -3z" />
        </g>
      </g>
    </svg>
  );
