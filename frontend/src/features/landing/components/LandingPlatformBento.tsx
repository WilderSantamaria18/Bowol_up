        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
          ...
          >
            ...
            <div>
              ...
              <h3 className="text-xl font-semibold text-white mt-6 tracking-tight group-hover:text-orange-300 transition-colors">
            ...
            <div className="mt-8 p-4 rounded-xl bg-white/[0.02] border border-white/[0.05] grid grid-cols-3 gap-4 text-center">
              ...
              <div>
                ...
                <p className="text-lg font-semibold text-emerald-400 mt-1 tabular-nums">
          ...
          >
            ...
            <div className="mt-6 p-3.5 rounded-xl bg-zinc-900/80 border border-white/5 text-xs text-zinc-300 flex items-center gap-2 shadow-inner">
          ...
          >
            ...
            <h3 className="text-xl font-semibold text-white mt-6 tracking-tight group-hover:text-amber-300 transition-colors">
              FODA Continuo
            </h3>
            <p className="mt-2 text-sm text-zinc-400 leading-relaxed">
          ...
          >
            ...
            <h3 className="text-xl font-semibold text-white mt-6 tracking-tight group-hover:text-emerald-300 transition-colors">
              Sprints y Tareas
            </h3>
            <p className="mt-2 text-sm text-zinc-400 leading-relaxed">
